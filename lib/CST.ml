...
type anon_choice_param_88d8a28 = [
    `Param of param
  | `Flag_param of (Token.t (* "--" *) * imm_tok_pat_f43f746)
]
...
type copy_instruction = (
    pat_copy
  * anon_choice_param_88d8a28 list (* zero or more *)
...
type flag_param (* inlined *) = (Token.t (* "--" *) * imm_tok_pat_f43f746)
