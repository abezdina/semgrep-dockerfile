...
(**
    Functions for parsing dockerfile programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a dockerfile program from a string into a typed OCaml CST.
...
(** Parse a dockerfile program from a file into a typed OCaml CST.
